...
export class MywebService {
  projects:Project[] = [
    ...
    {image: "../../../assets/images/1_7WeQGvRghyIVWVliG3kMsQ.png", link:"https://timetracking-71bf1.web.app/homepage",gitlink:"https://github.com/Acengen/TimeTrack", name:"TIMETRACK", desc:"This project tracks your time and storing it where you can check your total time.", way: "angular",cardimg:"../../../assets/images/420-4201852_vector-background-template-16001000-transprent-png-visiting-card.png"},
