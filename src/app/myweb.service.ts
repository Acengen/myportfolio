...
export class MywebService {
  projects:Project[] = [
    ...
    {image:"../../assets/images/kr0NhBb.jpg", link:null, name:"ADMINPANEL",desc:"Admins only web site", way:".NET Core & Angular", gitlink:"https://github.com/Acengen/Admin-Panel",cardimg:"../../../assets/images/420-4201852_vector-background-template-16001000-transprent-png-visiting-card.png"},
